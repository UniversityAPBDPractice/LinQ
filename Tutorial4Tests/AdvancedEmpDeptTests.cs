...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps.OrderBy(e => e.HireDate).Reverse().Take(2).ToList(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps,
                                e1 => e1.Mgr,
                                e2 => e2.EmpNo,
                                (sub, manager) => new { Employee = sub.EName, Manager = manager.EName}
        );
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .SelectMany(ed => grades.Where(g => g.Losal <= ed.emp.Sal && ed.emp.Sal <= g.Hisal),
                ((ed, salgrade) => new { ed.emp.EName, ed.dept.DName, salgrade.Grade }));
